...
<div class="grid grid-cols-12">
    <div class="chart1 col-span-12 lg:col-span-6"> 
    ...
    <div class="chart2 col-span-12 lg:col-span-6">  
        <div class="w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
    ...
    <div class="chart3 col-span-12 lg:col-span-6">     
        <div class="w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
    ...
    <div class="chart4 col-span-12 lg:col-span-6">  
        <div class="w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
    ...
    <div class="chart5 col-span-12 lg:col-span-6">           
        <div class="w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
            <div class="flex justify-between mb-5">
            <div>
...
<?php echo $__env->make('Seller.Layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\VS Code\VS Code Projects\Laravel\multi_vendor_ecommerce\resources\views/Seller/sellerDashboard.blade.php ENDPATH**/ ?>