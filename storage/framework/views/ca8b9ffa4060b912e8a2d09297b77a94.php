              ...
              <tbody class="">
                ...
                <tr>
                  ...
                  <td class="flex gap-1 w-48">
                    <form action="/update-cart" method="post" class="flex justify-between">
                       <?php echo csrf_field(); ?>
                       <input class="border rounded" type="hidden" name="id" value="<?php echo e($cart->id, false); ?>">
                       <label for="" class="my-auto mx-1">Quantity: </label>
                       <div class="relative">
                        <input class="w-36 pl-2 border rounded-xl" type="number" id="quantity" name="quantity" value="<?php echo e($cart->quantity, false); ?>">
                        <a class="absolute inset-y-0 right-0 my-auto" href="/update-cart">
                          <button class="px-2 py-1.5 mt-1 me-0.5 pt-0.5 bg-green-500 text-white font-semibold rounded-lg">Update</button>
                        </a>
                      </div>
                     </form>
                  </td>
                ...
                <tr class="border-b-2 border-gray-500">
                  <td colspan="">
                    Rs. <?php echo e($cart->product['product_price'] * $cart->quantity, false); ?>
...
</html><?php /**PATH D:\VS Code\VS Code Projects\Laravel\multi_vendor_ecommerce\resources\views/User/Layout/layout.blade.php ENDPATH**/ ?>