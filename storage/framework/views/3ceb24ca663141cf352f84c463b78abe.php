    ...
    <script>
        ...
        <div id="singleLineChart" class="singleLineChart col-span-12"> 
            <div class="w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
                ...
                <div>
                    <h5 id="totalNewUser" class="leading-none text-3xl font-bold text-gray-900 dark:text-white pb-2">32.4k</h5>
                ...
                <div class="flex justify-between items-center pt-5">
                    <!-- Dropdown menu -->
                    <select id="newUserDataDropDown" class="rounded-lg shadow">
                        <option value="7days">
                            Last 7 days
                        </option>
                        <option value="30days">
            ...
            <script>    
                var weeklyUserCount = <?php echo json_encode($weeklyUserCount, 15, 512) ?>;
                var monthlyUserCount = <?php echo json_encode($monthlyUserCount, 15, 512) ?>;
                var yearlyUserCount = <?php echo json_encode($yearlyUserCount, 15, 512) ?>;
...
</div><?php /**PATH D:\Visual Studio\VS Code Projects\Personal\Laravel\multi_vendor_ecommerce\vendor\open-admin-org\open-admin\src/../resources/views/dashboard/charts.blade.php ENDPATH**/ ?>