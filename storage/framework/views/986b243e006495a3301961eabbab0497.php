                ...
                <tr class="bg-gray-100 border-b border-gray-200 text-gray-900 hover:bg-blue-300">
                    ...
                    <td scope="row" class="px-6 text-base font-medium whitespace-nowrap dark:text-blue-100">
                        <a href="/get-product-details/<?php echo e($order->product['id'], false); ?>">
                            <button class="my-2 mx-auto bg-blue-600 px-5 py-2 rounded text-white font-semibold">View Details</button>
                        </a>
                    </td>
                </tr>                            
...
<?php echo $__env->make('Seller.Layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\VS Code\VS Code Projects\Laravel\multi_vendor_ecommerce\resources\views/Seller/orders.blade.php ENDPATH**/ ?>