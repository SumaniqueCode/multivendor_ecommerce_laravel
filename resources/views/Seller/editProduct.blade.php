...
<div class="">
    <div class="form my-8">
        <form class="max-w-xl mx-auto border-2 border-green-400 p-4 rounded-2xl py-8" method="post" action="">
            <legend class="font-bold text-center text-2xl mb-5">UPDATE PRODUCTS</legend>
            <div class="mb-5 name">
                <label htmlFor="product_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white text-left">product Title</label>
            ...
            <div class="mb-5">
                <label htmlFor="product_category" class=" text-left block mb-2 text-sm font-medium text-gray-900 dark:text-white">product Status</label>
