...
<script>
    ...
    var monthlyCashOrders = @json($monthlyCashOrders);
    var monthlyKhaltiOrders = @json($monthlyKhaltiOrders); 
    ...
    var weeklyClicks = @json($weeklyClicks);
    var weeklyCPC = @json($weeklyCPC);
    var monthlySales = @json($monthlySales);
    var monthlyClicks = @json($monthlyClicks);
    var monthlyCPC = @json($monthlyCPC);
        ...
        <div class="w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
            ...
            <div class="grid gap-4 grid-cols-3">
                <div>
                    ...
                    <p class="text-gray-900 dark:text-white text-2xl leading-none font-bold">{{ $totalWeeklyClicks }}</p>
                </div>
                <div>
                    ...
                    <p class="text-gray-900 dark:text-white text-2xl leading-none font-bold">Rs. {{ $totalWeeklyOrder }}</p>
                </div>
                <div>
                ...
                <p class="text-gray-900 dark:text-white text-2xl leading-none font-bold">Rs. {{ $totalWeeklyCPC }}</p>
                </div>
            </div>
            <div>
                <!-- Dropdown menu -->
